...
try {
    ...
    // Test mode flag from query (?testmode=1|true|yes)
    $testMode = false;
    if (isset($_GET['testmode'])) {
        $v = strtolower((string)$_GET['testmode']);
...
(function () {
    ...
    style.textContent = `
        ...
        /* Test mode: blinking button and visible hint with arrow */
    ...
    const openWidget = () => {
        ...
        // Hide test mode hint when widget is opened
        hideTestmodeHint();
